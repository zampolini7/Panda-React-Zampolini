    ...
    return(
        <div className="App container  ">
              ...
              <nav className="container-fluid navbar navbar-expand-lg navbar-light  d-flex fixed-top navBarPanda  ">
                  ...
                  <NavLink exact to={'/'} activeClassName="active-navlink" className="navlink align-self-center m-3"> PANDA </NavLink>
                  ...
                  <div className="collapse navbar-collapse d-flex" id="navbarNav">
                    <ul className="navbar-nav">
                      ...
                      <li className="nav-item align-self-center m-3">
                        <NavLink to={`/items/${itemsId}`}  activeClassName="active-navlink" className="navlink"> items </NavLink>
                      </li>
            
                      <li className="nav-item align-self-center m-3">
                        <NavLink to={'/contacto'}  activeClassName="active-navlink" className="navlink "> Contacto </NavLink>
                      </li>
